...
export function ChangelogStory() {
  return <article className="pb-24 sm:pb-32">
    <header className="mx-auto max-w-[1500px] px-5 pt-12 sm:px-10 sm:pt-20 lg:px-16">
      <div className="grid gap-10 border-b border-stone-200 pb-16 lg:grid-cols-[1.3fr_0.7fr] lg:items-end lg:pb-20">
        <div><div className="flex items-center gap-3 text-xs font-medium uppercase tracking-[0.18em] text-[#365DC4]"><span className="size-2 rounded-full bg-[#365DC4]"/>Changelog</div><h1 className="mt-8 max-w-5xl text-[clamp(4rem,9vw,9rem)] font-semibold leading-[0.84] tracking-[-0.075em]">Lo nuevo.<br/>Lo mejorado.<br/>Lo que sigue.</h1></div>
