...
export const metadata: Metadata = { title: 'Crear cuenta | shwcs', robots: { index: false, follow: false } };
export default async function SignUpPage(props:{searchParams: Promise<{next?:string;google?:string}>}) {
  ...
  return <section className="mx-auto max-w-[568px] px-6 pb-20 pt-8 sm:pt-14">
    ...
    <p className="mb-9 mt-4 text-base leading-relaxed text-stone-500">Crea tu cuenta y conoce lo que se está construyendo en México.</p>
    ...
    <AuthForm googleAvailable={!!googleConfig()} returnTo={returnTo} mode="register" />
  </section>;
}
