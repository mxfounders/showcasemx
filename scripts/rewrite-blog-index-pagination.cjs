              ...
              {totalPages > 1 && (
                <div className="mt-16 flex items-center justify-center gap-2 sm:gap-4 border-t border-stone-200 pt-10">
                  <button 
                    ...
                    disabled={page === 1}
                    className="action-button flex items-center gap-1.5 rounded-full border border-stone-200 bg-white px-4 sm:px-5 py-2 sm:py-2.5 text-sm font-medium text-stone-600 transition-colors hover:border-stone-900 hover:text-stone-900 disabled:opacity-50 disabled:pointer-events-none"
                  >
